    ...
    public function linkexternaldata($item)
    {
        ...
        if ($linkExternalData->hasExternalData == true){           
            ...
            switch ($linkExternalData->urlExternalData) {
                case "http://archive.org" : {
                    ...
                    $p = stripos($ID,"archive.org/details/");
                        if (!$p) {
                            return;/*warning to be added later*/
                        } else {
                           $link_found = true;
                           $image_found = true;
            ...
            if ($found){
                ...
                $toBePrinted .= '<p>link_to='.$link_to.'</p>';
                $toBePrinted .= '<p>img_src='.$img_src.'"</p>';
                $toBePrinted .= '<p>alt_image_comment='.$alt_image_comment.'</p>';
                $toBePrinted .= '<p>comment_after_thumbnail='.$comment_after_thumbnail.'</p>';                
